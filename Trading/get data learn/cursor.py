...
class Cursor:
   ...
   def __init__(self, timeframe: str, limit: int, date: str = datetime.now().strftime("%d.%m.%Y")):
      self.timeframe: str = timeframe
      self.limit: int = limit
      self.curs: int = self.datetime_to_milliseconds(date, "%d.%m.%Y")
   ...
   def datetime_to_milliseconds(self, date_str: str, date_format: str = "%d.%m.%Y %H:%M") -> int | None:
      """
